...
public class ExtentReportManager implements ITestListener {
	...
	public void onStart(ITestContext testContext){		
		...
		htmlReporter.config().setDocumentTitle("dotdashcom_Assessment Automation Report"); // Tile of report
		htmlReporter.config().setReportName("dotdashcom_Assessment Functional Testing"); // name of the report
